    ...
    private void OnRenderObject()
    {
        if (drawDebug)
        {
            if (points.Count > 0)
            {
                ...
                GL.Vertex3(Flock.CenterPosition.x, TerrainGenerator.PathHeight + 1, Flock.CenterPosition.z);
                GL.Vertex3(Flock.CenterPosition.x + (Flock.FlockAlignment.x * 5), TerrainGenerator.PathHeight + 1, Flock.CenterPosition.z + (Flock.FlockAlignment.z * 5));
